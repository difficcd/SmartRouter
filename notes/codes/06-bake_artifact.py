# 원본: training/bake_artifact.py (신규 파일, 전체 그대로)
...
# bake_artifact = 말 그래도 artifact.json 내용을 heuristic.py에 굽는 것.
# # BEGIN GENERATED ARTIFACT  "_TEAM_ARTIFACT_JSON "  # END GENERATED ARTIFACT
